...
array_push($routes, $route);//put the route into the array
#----------------------------------------------------------------------------------------------------------
// routes for submitting registration data
...
array_push($routes, $route);//put the route into the array
#----------------------------------------------------------------------------------------------------------
//A route to show the loginpage for the admin
$route= new route('GET', '/admin/login', function($parameters) {
    include './controllers/views/adminlogin.php';
});
array_push($routes, $route);//put the route into the array
#----------------------------------------------------------------------------------------------------------
//A route to process the login for the admin
$route= new route('POST', '/admin/submit_login', function($parameters) {
    include './controllers/Adminlogin.php';
});
array_push($routes, $route);//put the route into the array
#----------------------------------------------------------------------------------------------------------
//A test route to test the new middleware
$route= new route('GET', '/admin/test', function($parameters) {
    include './controllers/adminTest.php';
});
array_push($routes, $route);//put the route into the array
#----------------------------------------------------------------------------------------------------------
###########################################################################################################
...
################# Admin Routes #################
//A route to submit a new security
